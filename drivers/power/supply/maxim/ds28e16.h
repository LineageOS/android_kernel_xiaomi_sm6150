...
#define GET_USER_MEMORY_RETRY			3
#define GET_PERSONALITY_RETRY			3
#define GET_ROM_ID_RETRY				3
#define GET_BLOCK_STATUS_RETRY			3
#define SET_BLOCK_STATUS_RETRY			3
#define GET_MAC_RETRY					3
